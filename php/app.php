...
const NOTIFYROUTER_VERSION = '0.4.2';
...
const NOTIFYROUTER_RELEASE = 'https://github.com/terryrogers/notifyrouter/releases/tag/v0.4.2';
...
if($path==='/admin/setup'){
    ...
    if($_SERVER['REQUEST_METHOD']==='POST'&&$ok){$password=(string)($_POST['password']??'');if(strlen($password)<12)$error='Use at least 12 characters.';else{setv('admin_hash',password_hash($password,PASSWORD_DEFAULT));header('Location:/');exit;}}
